...
export default function Tablas() {
  ...
  useEffect(() => {
    const obtenerDocumentos = async () => {
      ...
      try {
        const response = await fetch(`https://archivo.app.informaticapp.com:9888/documentos/${message}`, {
          method: 'GET',
          headers: {
        ...
        const subcriteriosResponse = await fetch(`https://archivo.app.informaticapp.com:9888/tipocriterio/vercriterio/criteriomayor/${idcriteriomayor}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
          },
